      ...
      <div className="h-full flex justify-between w-full ">
        ...
        <div className="flex w-1/2 p-12 flex-col justify-center">
          ...
          <p className="text-lg">
            ...
            excepturi voluptatum recusandae architecto facere placeat itaque
            rem. Odit, blanditiis ipsa! Recusandae soluta dolorum nostrum
            voluptas provident. Qui ab quos quisquam.
          </p>
          <p className="text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea
            excepturi voluptatum recusandae architecto facere placeat itaque
