		...
		<div className='flex h-full w-full flex-col gap-10'>
			<div className='h-full flex justify-between w-full '>
				<img
					...
					alt=''
				/>
				<div className='flex w-1/2 p-12 flex-col justify-center'>
					<div className='bg-red-600 z-20 flex justify-center items-center md:h-32 h-14 w-full'>
					...
					<p className='text-lg'>
						...
						Ea excepturi voluptatum recusandae architecto facere
						placeat itaque rem. Odit, blanditiis ipsa! Recusandae
						soluta dolorum nostrum voluptas provident. Qui ab quos
						quisquam.
					</p>
					<p className='text-lg'>
						Lorem ipsum dolor sit amet consectetur adipisicing elit.
			...
			<div className='h-full flex flex-row-reverse justify-between w-full '>
				<img
					className='h-1/2 w-1/2'
					src='https://images.unsplash.com/photo-1682685797769-481b48222adf?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
					alt=''
				/>
				<div className='flex w-1/2 p-12 flex-col justify-center'>
					<h1 className='text-4xl mb-6'>SPEAKER NAME</h1>
					<p className='text-lg'>
						Lorem ipsum dolor sit amet consectetur adipisicing elit.
						Ea excepturi voluptatum recusandae architecto facere
						placeat itaque rem. Odit, blanditiis ipsa! Recusandae
