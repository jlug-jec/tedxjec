							...
							<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
								...
								<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
									...
									<p className='md:text-left text-center mt-3'>
										Tanu Jain is a 2015 batch IAS officer.
										After becoming an IAS officer, she
										continued her social service works as
										well as motivational speaking sessions.
										Recently, Tanu Jain decided to quit her
										job as an IAS officer and become a
										full-time teacher.
									</p>
									<div className='flex z-20 gap-6 md:justify-between md:w-[50%] justify-center md:h-auto mt-3'>
										<a href='https://www.instagram.com/dr.tanujain/' rel="noreferrer " target="_blank">
										...
										<a href='https://www.linkedin.com/in/dr-tanu-jain-4aa28a131/?original_referer=https%3A%2F%2Fwww%2Egoogle%2Ecom%2F&originalSubdomain=in' rel="noreferrer " target="_blank">
										...
										<a href='https://twitter.com/DrTanuJain1?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor'  rel="noreferrer " target="_blank">
