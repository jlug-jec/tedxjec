								...
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											Sudhir Kumar Mishra, a distinguished
											Indian engineer, defense scientist,
											and dedicated civil servant,
											currently holds the esteemed
											position of Director General at the
											Defence Research & Development
											Organisation. Additionally, he
											serves as the Chief Executive
											Officer and Managing Director of
											BrahMos Aerospace, a renowned joint
											venture between the defense
											ministries of India and Russia.
										</p>
							...
							<div className='md:h-[450px]  md:w-[850px] z-10 flex md:gap-44 md:my-12 my-8 md:mx-0 mx-3  border-2 border-red-600 rounded-2xl relative'>
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											Mr. Dhainu Das is a distinguished
											business leader, serial
											entrepreneur, and investor renowned
											for his commitment to empowering
											startups and entrepreneurs across
											India. With a wealth of experience
											in investment, operations, strategy,
											and development, Das has mentored
											numerous startups to success while
											leading major business turnarounds
											and establishing new ventures.
										</p>
										<div className='flex z-20 gap-6 md:justify-between md:w-[50%] justify-center md:h-auto mt-3'>
											<a
							...
							<div className='md:h-[450px]  md:w-[850px] z-10 flex md:gap-44 md:my-12 my-8 md:mx-0 mx-3  border-2 border-red-600 rounded-2xl relative'>
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											In the poetic rhythm of life, she
											gracefully embraces a multitude of
											roles crafting smiles in the realm
											of dentistry, skillfully navigates
											diverse bureaucratic landscapes and
											engages as a speculative thinker,
											exploring the intricate tapestry of
											existence with contemplative
											depth.In her role as a Mock
											Interview panelist, speaker,
											wordsmith and contemplative mind,
											she intricately spins her tale.
										</p>
										<div className='flex z-20 gap-6 md:justify-between md:w-[50%] justify-center md:h-auto mt-3'>
											<a
							...
							<div className='md:h-[450px]  md:w-[850px] z-10 flex md:gap-44 md:my-12 my-8 md:mx-0 mx-3  border-2 border-red-600 rounded-2xl relative'>
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											Mrs. Sampada Singh Gurjar is
											currently the Deputy Collector of
											Narmadapuram. She is an amazing
											speaker, mentor, and notable alumni
											of Jabalpur Engineering College. She
											completed her Btech. and has
											achieved huge milestones at a very
											young age. She secured the first
											rank in MPPSC 2017 and was appointed
											as the Deputy Collector in the
											Singrauli district.
										</p>
								...
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											...
											unparalleled expertise, Mr. Prashant
											Pole stands as a beacon of
											excellence in the telecommunications
											realm. His illustrious career,
											spanning more than 35 years,serves
											as a testament to his unwavering
											commitment to innovation and
											progress in the industry. Mr.
											Pole&apos;s influence extends far
											beyond borders.Through various
											training programs,he imparts
											invaluable wisdom in cutting-edge
								...
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											...
											artistry and artistry meets
											innovation.&quot; Crafting cinematic
											magic in every frame and note,
											Nitish Mishra, a Maestro of Melody,
											stands out as an excellent director,
											editor, and cinematographer of music
											videos at Canvas Films. He is a
											visionary founder of &quot;Ashwamedh
											Studios,&quot; which released films
											like &quot;Tiger Guards of
											Kanha,&quot; and a profound creative
											head at &quot;HELIX&quot;.
										</p>
										<div className='flex z-20 gap-6 md:justify-between md:w-[50%] justify-center md:h-auto mt-3'>
											<a
							...
							<div className='md:h-[450px]  md:w-[850px] z-10 flex md:gap-44 md:my-12 my-8 md:mx-0 mx-3  border-2 border-red-600 rounded-2xl relative'>
								<div className='md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col'>
									...
									<div className='md:w-1/2 flex flex-col justify-between gap-3 p-3 '>
										...
										<p className='md:text-left text-center mt-3'>
											Vivek Samtani, hailing from
											Jabalpur, ascended to comedic
											stardom with his magnetic
											performances. Transitioning from
											humble open-mic gigs to television
											triumphs, his journey embodies sheer
											determination and raw talent.
											Infusing storytelling and satire,
											Vivek&apos;s humor strikes a chord,
											captivating audiences nationwide.
											Beyond stand-up, his ventures into
											writing and acting underscore his
