                ...
                <div className="md:w-[850px] flex md:gap-4 rounded-2xl bg-zinc-900 p-3 md:flex-row flex-col">
                  ...
                  <div className="md:w-1/2 flex flex-col justify-between gap-3 p-3 ">
                    ...
                    <p className="md:text-left text-center mt-3">
                      Tanu Jain is a 2015 batch IAS officer. After becoming an
                      IAS officer, she continued her social service works as
                      well as motivational speaking sessions. Recently, Tanu
                      Jain decided to quit her job as an IAS officer and become
                      a full-time teacher.
                    </p>
